...
void Drone::update(double dt) {
  ...
  if (toPackage) {
    ...
    if (toPackage->isCompleted()) {
      ...
      toPackage = nullptr;
      pickedUp = true;
      this->notify("pickedup", *this);
      this->notify("moving", *this);
    }
...
int Drone::getSpecificId() const {
  return droneID;
}

int Drone::getPackageNumber() const {
  return package->getSpecificId();
}
